...
import com.generation.farmacia.model.Produto;
	...
	@Repository
	public interface ProdutoRepository extends JpaRepository<Produto, Long>{ //herança
		...
		public List <Produto> findByNomeOrLaboratorio(String nome, String laboratorio);
		 ...
		 // Método buscarProdutosEntre: Retorna todos os produtos cujo preço esteja entre dois valores informados nos parâmetros (valor inicial, valor final)
		  
		 // Anottation @Query -> Permite executar uma consulta no Spring utilizando código SQL nativo
		 ...
		 // @Param("inicio") -> Mapeia o parâmetro :inicio da consulta na variável BigDecimal inicio que é o primeiro parâmetro do método buscarProdutosEntre
		
		 // @Param("fim") -> Mapeia o parâmetro :fim da consulta na variável BigDecimal fim que é o segundo parâmetro do método buscarProdutosEntre
